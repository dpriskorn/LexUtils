...
#         print(
#             f"working on {document_id} ({count_file}/{len(files)}) "
...
#                     len(re.findall(r"\d+|\(|\)|§|\[|\]|\/", sentence)) == 0
#                     and sentence[0:1] != " "
#                     and sentence[0:1] != ","
#                     and not str(sentence[0:1]).islower()
#                     and langdetect.detect(sentence) == self.language_code.value
#                 ):
